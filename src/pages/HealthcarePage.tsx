  ...
  const benefits = [
    {
      ...
      description:
        "Utilising materials that are designed for safe medical use.",
    },
    {
      title: "Precise Engineering",
      description:
        "Protecting sensitive medical equipment with tailored solutions.",
    },
    {
      title: "Cost-Efficient Repairs",
      description:
        "Extending the lifecycle of products through expert refurbishment.",
    },
    {
      title: "Compliance Assured",
      description:
        "Our packaging solutions meet the regulatory requirements for healthcare applications.",
    },
  ];
