  ...
  const benefits = [
    {
      ...
      description:
        "Built to withstand harsh outdoor conditions, ensuring longevity and reliability in the field.",
    },
    {
      title: "Cost Savings",
      description:
        "Repairs and refurbishment services keep replacement spend to a minimum.",
    },
    {
      title: "Flexible Design",
      description:
        "Bespoke solutions tailored to the unique needs of agricultural operations.",
    },
    {
