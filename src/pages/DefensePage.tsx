  ...
  const benefits = [
    {
      ...
      description:
        "Our production facilities are based entirely in the UK, ensuring security and reliability.",
    },
    {
      title: "Military-Grade Durability",
      description:
        "Our packaging solutions are engineered for the toughest environments, ensuring high protection.",
    },
    {
      title: "Lifecycle Extension",
      description:
        "We repair and refurbish existing packaging to save costs and reduce waste.",
    },
    {
      title: "Quick Turnaround",
      description:
        "Agile manufacturing processes ensure fast delivery times to meet urgent defence needs.",
    },
  ];
