...
function BrandLogos() {
    ...
    const logos = [am, bentley, bmw, landrover, tgw, jaguar, vauxhall, renault, honda, ruthlee, toyota, ford, buse, nissan, volkswagen, j9];

    return (
        <>
        <h2 className="text-base md:text-lg font-semibold text-impacta11 mb-8 text-right pr-28 text-opacity-75">Brands Who Trust Us</h2>
