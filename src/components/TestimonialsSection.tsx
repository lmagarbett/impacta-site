  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      >
        ...
        <div className="relative z-10 pl-0 xl:pl-48">
          ...
          <p className="max-w-2xl text-lg text-gray-200">
            Trusted by Automotive, MOD, Healthcare, and Beyond — See Why Clients
            Choose Impacta
          </p>
      ...
      <section className="relative py-28 bg-white px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center md:text-left">
          ...
          <div className="relative">
            ...
            >
              <svg
                className="w-4 h-4 text-impacta11"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #f8fafc 0%, #e0f2fe 50%, #044BAB 100%)",
        }}
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              We're proud to partner with some of the world's most respected
              automotive and industrial brands, delivering innovative packaging
          ...
          <div className="text-center mt-12">
            <p className="text-gray-700 text-lg">
              And many more industry-leading companies trust Impacta for their
              packaging needs.
            </p>
          </div>
        </div>
