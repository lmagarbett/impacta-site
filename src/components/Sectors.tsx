...
const sectors = [
  { 
    title: "Automotive", 
    description: "Returnable containers for EV and ICE logistics",
    ...
    icon: (
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-full h-full text-impacta1"
      >
  ...
  { 
    ...
    description: "Robust, secure stillages for defense contracts",
  ...
  { 
    title: "Healthcare", 
    description: "Sanitisable metal packaging for medical supply chains",
  ...
  { 
    ...
    description: "Custom solutions including gas bottle stillages and more",
  ...
  { 
    title: "Agriculture", 
    description: "Durable solutions for agricultural equipment and supply transport",
        ...
        {sectors.map((sector, i) => (
          ...
          >
            <div className="absolute top-2 right-2 opacity-10 pointer-events-none">
              <div className="w-16 h-16 text-impacta1">
                {sector.icon}
              </div>
            </div>
            <div className="relative z-10">
              <h3 className="text-xl font-semibold mb-2 text-impacta1">{sector.title}</h3>
